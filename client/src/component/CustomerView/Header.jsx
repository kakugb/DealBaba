...
export default function Header() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-100  border-opacity-60 border-slate-700 fixed w-full top-0 left-0 z-30 shadow-lg shadow-gray-300">
